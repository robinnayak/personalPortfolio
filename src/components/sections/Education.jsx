...
const Education = ({bg_color}) => {
  return (
    <div className={`container rounded-b-2xl max-h-[50vh] max-w-full ${bg_color} relative overflow-hidden mb-5 py-8 px-4 rounded-xl`}>
      {/* Education Icon */}
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16 justify-evenly">
        ...
        <div className="min-w-full flex justify-evenly md:items-start">
          ...
          <div className="">
            <div className="transform -translate-x-1/2 w-2 min-h-screen bg-white mx-4"></div>
          </div>
